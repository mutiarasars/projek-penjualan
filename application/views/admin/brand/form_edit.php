        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <form method="POST" action="<?= site_url('admin/brand/save_update'); ?>" enctype="multipart/form-data" class="needs-validation" novalidate="">
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_brand" class="form-control" required="" value="<?= $brand->nama_brand; ?>">
                                </div>
                                <div class="form-group">
