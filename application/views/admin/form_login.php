                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?= base_url() ?>assets/img/logo_login/admin.png" alt="logo" width="100" class="shadow-light rounded-circle">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <?php } ?>
                            <div class="card-body">
                                <form method="POST" action="<?= site_url('admin/login/aksi_login'); ?>" class="needs-validation" novalidate="">
