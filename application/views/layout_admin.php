            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= base_url() ?>assets/admin/assets/img/products/product-3-50.png" alt="product">
                                    oPhone S9 Limited Edition
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= base_url() ?>assets/admin/assets/img/products/product-2-50.png" alt="product">
                                    Drone X2 New Gen-7
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= base_url() ?>assets/admin/assets/img/products/product-1-50.png" alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                            <div class="search-header">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, Bruh</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= site_url('admin/login/logout'); ?>" class="dropdown-item has-icon text-danger">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="nav-link" href="<?= site_url('admin/brand') ?>"><i class="fas fa-fire"></i><span>Brand</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= site_url('admin/produk') ?>"><i class="fas fa-fire"></i><span>Produk</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= site_url('admin/pengguna') ?>"><i class="fas fa-fire"></i><span>Member</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= site_url('admin/transaksi') ?>"><i class="fas fa-fire"></i><span>Transaksi</span></a>
                    </ul>
                </aside>
            </div>
